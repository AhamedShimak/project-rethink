  ...
  <div className="lesson__container">
    ...
    <div className="lesson__content">
      <div className="lesson__content__item">
        ...
        <p className="lesson__content__item__content__title">Title of Link</p>
        <p className="lesson__content__item__content__text">string dogy yalu strong string dogy yalu strong</p>
